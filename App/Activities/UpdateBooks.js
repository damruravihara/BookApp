...
const UpdateBooks = ({route,navigation}) => {
        ...
        const onValueChange = database()
          ...
          .on('value', snapshot => {
            if(snapshot.val() != null){
              onChangeList(snapshot.val())
              onChangeTitle(list.Title)
              onChangeType(list.Type)
              onChangeDescription(list.Description)
              onChangePrice(list.Price)
              onChangeDate(list.DueDate)
              onChangeAuthor(list.Author)
            }
          });
    ...
    <ImageBackground source={background} resizeMode="cover" style={styles.image}>
      <ScrollView>
          ...
          <View style={styles.goalTitleWrapper}>
              <Text style={styles.goalTitle}>UPDATE BOOK</Text>
              <Text style={styles.goalTitle}>{list.Title}</Text>
          </View>
          <Text style={styles.inputText}>Author: </Text>
          <TextInput style={styles.input} placeholder="Book Author" defaultValue={list.Author} onChangeText={(text) => onChangeAuthor(text)}/>
          <Text style={styles.inputText}>Type: </Text>
          <TextInput style={styles.input} placeholder="Book Type" defaultValue={list.Type} onChangeText={(text) => onChangeType(text)}/>
          <Text style={styles.inputText}>Description: </Text>
          <TextInput style={styles.input} placeholder="Book Description" defaultValue={list.Description} onChangeText={(text) => onChangeDescription(text)}/>
          <Text style={styles.inputText}>Price: </Text>
          <TextInput style={styles.input} placeholder="Book Price" defaultValue={list.Price} onChangeText={(text) => onChangePrice(text)}/>
          {/* <View style={styles.dateWrapper}>
            <Text style={styles.dateText}>Select Goal Date ({list.DueDate}) </Text>
          <RNPickerSelect placeholder={{label: 'Update Year', value: 'Update Year'}}
      ...
      />
      <RNPickerSelect placeholder={{label: 'Update Month', value: 'Update Month'}}
      ...
      />
          <RNPickerSelect placeholder={{label: 'Update Day', value: 'Update Day'}}
      ...
      />
          ...
          <View style={styles.createButtonWrapper}>
              <Button title="UPDATE" onPress={onUpdate} style={styles.createButton} />
      </View>
      </View>
